...
In machine learning projects, the testing and validation phases are often performed manually, which makes them slow and difficult to reproduce. Automation is essential to ensure the reliability of these phases. This project aims to automate these steps using Git workflows and CML. An initial CI/CD approach will be implemented, applied to machine learning using Git workflows and CML. This will standardize test execution and automatically generate performance reports.
...
1. Automate model testing (medium level)
2. Automate model performance comparison (hard level)

## Part 1. Automate model testing (medium level)
...
1. Open the script `wine_linear_regression_test.py` given in the [lab-2-cml](./lab-2-cml) folder and inspect which libraries we need for the code to run.
...
## Part 2. Automate model performance comparison (hard level)
